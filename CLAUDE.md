...
7. **Testing**: Run tests after changes using `./vendor/bin/phpunit` or `php artisan test`
8. **Code Quality**: Follow existing code style and patterns throughout the codebase
